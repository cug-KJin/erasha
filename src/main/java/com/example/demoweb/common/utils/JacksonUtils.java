...
public class JacksonUtils {
    ...
    /** * 将java对象转换为字符串 * @param param java 对象 * @return json字符串 */
    public static String toJson(Object param){
        try {
            ObjectMapper objectMapper = JacksonUtils.getMapperInstance(false);
    ...
    /** * 将java对象为字符串 类名作为json的顶级属性 * @param param java 对象 * @returnjson字符串 */
    ...
    /** * 将json字符串转换为java对象 * @param json json字符串 * @param cls java对象类型 * @param <T> * @return */
    ...
    /** * 将json字符串转换为java对象 ，解析字符串时，将类的名字或者别名作为顶级属性来解析 * @param json json字符串 * @param cls java对象类型 * @param <T> * @return */
    ...
    /** * 将json字符串转换为java对象 * @param json json字符串 * @param typeReference 复杂的java对象类型 * @param <T> * @return */
    ...
    /** * 将json字符串转换为java对象，解析字符串时，将类的名字或者别名作为顶级属性来解析 * @param json json字符串 * @param typeReference 复杂的java对象类型 * @param <T> * @return */
    ...
    /** * 从json字符串中读取出指定的节点 * * @param json * @param key * @return * @throws JsonProcessingException * @throws IOException */
